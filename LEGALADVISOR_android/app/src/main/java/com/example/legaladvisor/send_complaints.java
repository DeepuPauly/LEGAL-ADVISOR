...
public class send_complaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/view_comp_reply";
        RequestQueue queue1 = Volley.newRequestQueue(send_complaints.this);
        ...
        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    //lv.setAdapter(ad);
                    l1.setAdapter(new custom3(send_complaints.this,comp,reply,date));
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("success")) {
                                    Toast.makeText(send_complaints.this, "send successfully", Toast.LENGTH_SHORT).show();
