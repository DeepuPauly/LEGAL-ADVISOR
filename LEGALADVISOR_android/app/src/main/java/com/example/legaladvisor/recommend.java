...
public class recommend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/recommended";
        RequestQueue queue1 = Volley.newRequestQueue(recommend.this);
        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    l1.setAdapter(new cust_exam(recommend.this,gd,place,phone,gid));
...
//                    l1.setOnItemClickListener(searchadvocates.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(recommend.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
