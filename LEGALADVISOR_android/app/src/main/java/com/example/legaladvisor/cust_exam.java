...
public class cust_exam extends BaseAdapter {
    private Context context;
    ArrayList<String> a;
    ArrayList<String> b,c,d;
    SharedPreferences sh;
    public cust_exam(Context applicationContext,ArrayList<String> a, ArrayList<String> b, ArrayList<String> c,ArrayList<String> d) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_cust_exam, null);
        }
        else
        {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(context,schedule.class);
