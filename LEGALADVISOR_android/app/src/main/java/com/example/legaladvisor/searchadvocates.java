...
public class searchadvocates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_searchadvocates);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        l1=findViewById(R.id.lv1);
        url ="http://"+sh.getString("ip", "") + ":5000/view_advocate";
        RequestQueue queue1 = Volley.newRequestQueue(searchadvocates.this);
        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    l1.setAdapter(new cust_exam(searchadvocates.this,gd,place,phone,gid));
...
//                    l1.setOnItemClickListener(searchadvocates.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(searchadvocates.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
