...
public class cust_adv extends BaseAdapter {
    private Context context;
    ArrayList<String> a;
    ArrayList<String> b,c,d;
    SharedPreferences sh;
    public cust_adv(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c, ArrayList<String> d) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_cust_adv, null);
        }
        else
        {
