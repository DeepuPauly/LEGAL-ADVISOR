...
public class cust_sched extends BaseAdapter {
    private Context context;
    ArrayList<String> a;
    ArrayList<String> b,c,d;
    SharedPreferences sh;
    public cust_sched(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c, ArrayList<String> d) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_cust_sched, null);
        }
        else
        {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(context,case_register.class);
                in.putExtra("aid",d.get(position));
